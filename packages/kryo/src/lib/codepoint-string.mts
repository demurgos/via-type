...
import { createMaxCodepointsError } from "./errors/max-codepoints.mjs";
import { createMinCodepointsError } from "./errors/min-codepoints.mjs";
import { createMissingDependencyError } from "./errors/missing-dependency.mjs";
    ...
    switch (this.normalization) {
      ...
      default:
        throw new incident.Incident(
          `IncompleteSwitch: Received unexpected variant for this.normalization: ${this.normalization as string}`,
        );
    }
